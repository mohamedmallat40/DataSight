...
export default function UnifiedContactModal({ isOpen, onOpenChange, onSuccess }: UnifiedContactModalProps) {
                      ...
                      <div className="w-16 h-16 bg-default-100 dark:bg-default-200 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-primary/10 transition-colors duration-200">
                        <Icon 
                          ...
                          className={`transition-colors duration-200 ${
                            method.id === 'ocr' ? 'text-blue-600' :
                            method.id === 'linkedin' ? 'text-purple-600' :
                            method.id === 'csv' ? 'text-orange-600' :
                            method.id === 'manual' ? 'text-green-600' :
                            'text-default-600'
                          }`}
                        />
                      </div>
          ...
          >
            <div className="flex items-center gap-3 p-6 border-b border-default-200">
              ...
              <div className="flex items-center gap-2">
                <Icon icon="solar:camera-linear" className="text-blue-600" width={20} />
                <h2 className="text-lg font-semibold">Business Card Scan</h2>
              </div>
            </div>
            <MultiStepWizard onClose={handleBackToSelection} onSuccess={handleWizardSuccess} />
          </motion.div>
        );
        ...
        return (
          ...
          >
            <div className="flex items-center gap-3 p-6 border-b border-default-200">
              ...
              />
              <div className="flex items-center gap-2">
                <Icon icon="solar:link-linear" className="text-purple-600" width={20} />
                <h2 className="text-lg font-semibold">LinkedIn Import</h2>
              </div>
            </div>
            <LinkedInScrapeWizard onClose={handleBackToSelection} onSuccess={handleWizardSuccess} />
          </motion.div>
        );
        ...
        return (
          ...
          >
            <div className="flex items-center gap-3 p-6 border-b border-default-200">
              ...
              />
              <div className="flex items-center gap-2">
                <Icon icon="solar:document-linear" className="text-orange-600" width={20} />
                <h2 className="text-lg font-semibold">CSV Import</h2>
              </div>
            </div>
            <CSVImportWizard onClose={handleBackToSelection} onSuccess={handleWizardSuccess} />
          </motion.div>
        );
        ...
        return (
          ...
          >
            <div className="flex items-center gap-3 p-6 border-b border-default-200">
              ...
              />
              <div className="flex items-center gap-2">
                <Icon icon="solar:user-plus-linear" className="text-green-600" width={20} />
                <h2 className="text-lg font-semibold">Manual Entry</h2>
              </div>
            </div>
            <ManualFormWizard onClose={handleBackToSelection} onSuccess={handleWizardSuccess} />
          </motion.div>
        );

...
export default function ContactMethodSelector({
  ...
  const [selectedMethod, setSelectedMethod] =
    React.useState<ContactMethod | null>(null);
  const {
    isOpen: isWizardOpen,
    onOpen: onWizardOpen,
  ...
  return (
    <>
            ...
            >
              ...
              >
                <CardBody className="p-6 text-center relative">
                  ...
                  <div
                    className={`w-16 h-16 ${method.iconColor} bg-white dark:bg-default-100 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200`}
                  >
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-small text-default-600">
              ...
              <ul className="space-y-1 text-tiny">
                ...
                <li>
                  • <strong>LinkedIn Import:</strong> Perfect for networking and
                  sales outreach
                </li>
                <li>
                  • <strong>CSV Import:</strong> Ideal for migrating from other
                  systems
                </li>
                <li>
      ...
      >
        <ModalContent>
          <ModalBody className="p-0">{renderWizard()}</ModalBody>
        </ModalContent>
      </Modal>
    </>
  );
